...
uchar Electricity[5]   = {0xff,0x60,100,0x00,0xff};  //电量
uchar Electricity_1[5] = {0xff,0x60,0x22,0x00,0xff}; //电量
uchar Humidity[5]      = {0xff,0x61,0x00,0x00,0xff}; //湿度
uchar Temperature[5]   = {0xff,0x62,0x00,0x00,0xff}; //温度
uchar Concentration[5] = {0xff,0x63,0x00,0x00,0xff}; //浓度
...
{ 
    ...
    Serial.write(Electricity, 5);  //发送一帧电量数据
...
void Dht11()
{
  ...
  *****************************/
  ...
  float val1  = val*12/1023;     //电压，12为基准电压
        Val_E = val1/12*100;     //电量百分比
  Serial.print("模拟量:");
  Serial.print(val);
  Serial.print("\t");
  Serial.print("电压:");
  ...
  *****************************/
  ...
  {
  float val_1   = analogRead(Elec_2PIN);
  float val1_1  = val_1*12/1023;//电压，12为基准电压
        Val_E_1 = val1_1/12*100;//电量百分比
  Serial.print("模拟量:");
  Serial.print(val_1);
  Serial.print("\t");
  Serial.print("电压:");
